...
export default function RootLayout({
  ...
  return (
    <html lang="es" className={`${openSans.variable} overflow-x-clip`} suppressHydrationWarning>
      <head>
      ...
      <body className="flex flex-col min-h-screen bg-white text-brand-black antialiased overflow-x-clip">
        <GoogleAuthProvider>
          <Header />
          <main className="grow">
            {children}
