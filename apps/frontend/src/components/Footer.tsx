...
export default function Footer() {
  return (
    <footer className="w-full bg-[#0a0b0e] text-slate-400 border-t border-white/5 py-16">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          {/* Brand details */}
          <div className="md:col-span-2">
            <h3 className="font-display text-white text-lg font-bold tracking-wider mb-4">
              PAPES CONFORT
            </h3>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm">
              ...
              <li>
                <Link href="/catalogo" className="hover:text-white transition-colors duration-200">
                  Catálogo
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm">
              <li className="text-slate-500">Garantías Oficiales</li>
              <li className="text-slate-500">Términos y Condiciones</li>
              <li className="text-slate-500">Políticas de Privacidad</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
          <p>&copy; {new Date().getFullYear()} Lautaro Gregoraschuk. Todos los derechos reservados.</p>
          <p className="text-slate-500">Servicio y calidad asegurados.</p>
        </div>
      </div>
    </footer>
  );
